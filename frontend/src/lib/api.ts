...
export type BoardOption = Schemas['BoardOption']
...
export type CheckCall = Schemas['CheckCallOut']
export type CheckCallCreate = Schemas['CheckCallCreate']
export type BillingStatus = Schemas['BillingStatus']
export type PlanInfo = Schemas['PlanInfo']
export type CarrierVetting = Schemas['CarrierVettingOut']
export type CarrierLookup = Schemas['CarrierLookupOut']
export type MarketRate = Schemas['MarketRateOut']
