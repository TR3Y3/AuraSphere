...
- Current phase: **Product track — Stripe plan-gating (complete)**. Next product-track candidates: Gmail/Apollo + DAT/Highway/factoring/ELD integrations; or deferred cleanup (companies→shippers rename, remove legacy deals backend).
- Last completed: Stripe plan-gating (Free vs Pro) with a stub mode + a real-Stripe mode.
