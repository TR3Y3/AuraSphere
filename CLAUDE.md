...
- Current phase: **Product track — ELD telematics integration (complete)**. Next candidates: Gmail email-logging, factoring; or deferred cleanup (companies→shippers rename, remove legacy deals backend).
